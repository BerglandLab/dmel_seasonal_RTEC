...
pops20 = read.table("/scratch/users/hmachado/nescent_melCA/data/paired_spring_fall_populations_noWI13PA9PA12PA14PA15.txt", stringsAsFactors=FALSE)[,1]
load("/scratch/users/hmachado/nescent_melCA/glm_permutations/switching_pop20_permutations.Rdata") # list: "switching"
