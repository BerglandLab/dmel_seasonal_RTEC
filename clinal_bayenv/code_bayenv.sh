...
## Populations used for clinal regression (and latitude)
...
bayenv2 -i clinal_snpsfile_Feb2019_sample10K.txt -s clinal_samplefile_Feb2019.txt -p 4 -k 100000 -x -r 63479 > matrix_10Kbsub100Kiter.out
