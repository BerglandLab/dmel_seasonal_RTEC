...
for i in {1..500}; do
    Rscript analyze_permuted_July2020_suppfigures_permsplitsv2_pvalue004.R $i
done
...
for i in {1..500}; do
    Rscript analyze_permuted_July2020_suppfigures_permsplitsv2_pvalue004_inversionbrkpts_500Kb.R $i
done
