...
# intially run for all populations
# subsequently reduce to focal populations
while read line; do
    Rscript make_inputfiles.R ../data/mel_freqdp_042016_Ne_fixed_correctBAVI.Rdata $line input_files/$line.alt_dp
...
mkdir -p results
Rscript calculate_fishers_method_Jan2017.R fisher_exactJ_pop20/greater_rank_fisher_exactJ.merged.20pop.polymorphic.txt fisher_exactJ_pop20/greater_rank_fisher_exactJ.merged.20pop.polymorphic.txt L_rank_fisher_exactJ.merged.20pop.polymorphic.txt
