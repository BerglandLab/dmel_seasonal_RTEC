...
Rscript clinal_analysis_uniquepops_springPA_noMA.R data/mel_freqdp_042016_Ne_fixed_correctBAVI.Rdata mel_clinal_uniquepops_springPA_noMA.glm
...
for chrom in 2L 2R 3L 3R; do
    Rscript ../create_input_files/match_snps_dp_ch_SNPbySNP_recomb_chromposFilter.R ../data/means_dpfreq.$chrom.medfreq01_RRgrt0.recRate.Rdata bootstrap/bootstrap_fmean_dp.mel_$chrom.medfreq01_RRgrt0.recRate.polymorphic.txt 100 ../data/chrom_pos_polymorphic_medfreq01_RRgrt0.txt
done
# bootstrap results too large to include on github, so file is located on datadryad: https://doi.org/10.5061/dryad.4r7b826
# All chromosomes combined, filtered to include the set of analyzed SNPs
# filename: bootstrap_fmean_dp.mel.medfreq01_RRgrt0.recRate.polymorphic.txt
